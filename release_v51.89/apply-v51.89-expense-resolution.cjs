...
try {
  ...
  console.log('\n============================================');
  console.log(`지출결의서 작성 ${VERSION} 경로·km 및 상하 배치 적용 완료`);
  console.log('============================================');
  console.log('\n[적용 파일]');
  ...
  console.log('3. 출발지와 이동거리(km) 일괄 입력 후 목록 반영 확인');
  console.log('4. 상단 미리보기·하단 사용내역 배치와 엑셀 다운로드 확인');
