...
try {
  ...
  console.log('\n============================================');
  console.log(`지출결의서 작성 ${VERSION} 토스트 알림·목록 총금액 수정 적용 완료`);
  console.log('============================================');
  console.log('\n[적용 파일]');
  ...
  console.log('2. 엑셀 다운로드·PDF 업로드 알림이 상단 중앙 토스트로 표시되는지 확인');
  console.log('3. 저장 후 목록 화면에서 저장 완료 토스트가 유지되는지 확인');
  console.log('4. 목록 총금액에 유류비와 통행료가 모두 포함되는지 확인');
  console.log('5. 엑셀 날짜 형식·상세내역 문구·색상 유지 확인');
