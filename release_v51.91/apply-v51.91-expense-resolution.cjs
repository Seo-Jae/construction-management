...
try {
  ...
  console.log('\n============================================');
  console.log(`지출결의서 작성 ${VERSION} 좌우 폭 조절·동적 미리보기 적용 완료`);
  console.log('============================================');
  console.log('\n[적용 파일]');
  ...
  console.log('2. 지출결의서 신규 작성 화면에서 좌우 배치 확인');
  console.log('3. 가운데 조절선을 드래그해 양쪽 폭 조절 확인');
  console.log('4. 사용 항목에 따른 갑지 미리보기 열 자동 표시 확인');
  console.log('5. 엑셀 날짜 형식과 상세내역 색상 유지 확인');
