...
const files = [
  ...
  },
  {
    ...
    label: 'public/images/wooklim-logo-transparent.png',
  },
];
...
try {
  ...
  console.log('\n============================================');
  console.log('사내시스템 v51.96 관리영역 헤더 수정 적용 완료');
  console.log('============================================');
  console.log('\n[적용 파일]');
  ...
  console.log('3. 좌측 상단 투명 빨간 로고 확인');
  console.log('4. 공사 관리 드롭다운에서 안전 관리 전환 확인');
  console.log('5. 브랜드 영역 맨 오른쪽 접기·펼치기 확인');
