...
try {
  ...
  console.log('\n============================================');
  console.log('사내시스템 v51.99 권한 2단계 적용 완료');
  console.log('============================================');
  console.log('\n[적용 파일]');
  ...
  console.log('\n중요: 회원관리 화면을 열기 전에 Supabase SQL을 먼저 실행해야 합니다.');
  console.log('- Supabase에서_실행_회원권한_2단계_v51.99.sql');
  console.log('\n다음 순서');
  console.log('1. npm run build');
  console.log('2. npm run dev');
  console.log('3. 최고관리자 계정으로 회원관리 저장 테스트');
  console.log('4. 노임·자재 화면의 시작월·종료월 한국어 표기 확인');
