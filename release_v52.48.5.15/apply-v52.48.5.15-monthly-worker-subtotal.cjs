...
const VERSION = 'v52.48.5.15';
const projectRoot = process.cwd();
const entry = {
  relativePath: 'src/page/MonthlyWorkerStatus.jsx',
  baseHash: '0ecb7f1f0ac996b8e1cd13e9af9fdfb8bd010abd',
  targetHash: 'e26acd9021107973d76b01a08eaf4afd0fb00e2e',
};
...
console.log(`\n${VERSION} 코드 적용 완료`);
console.log('- 금월 투입현황 명단 최하단에 소계 행 추가');
console.log('- 날짜별 투입 인원 소계 표시');
console.log('- 우측 합계 열에 월 총 공수 표시');
console.log('- 성명·직종 검색 시 화면에 보이는 명단 기준으로 소계 자동 재계산');
