...
export default function Dashboard({ user, userProfile, onLogout }) {
  ...
  */
  ...
  const managementAreaButtonSx = (area) => {
    const selected = managementArea === area;
        ...
        <Toolbar sx={{ minHeight: '56px !important' }}>
          ...
          >
            <Button
              ...
              onClick={() =>
                setManagementArea(MANAGEMENT_AREA_CONSTRUCTION)
              }
              sx={managementAreaButtonSx(
                MANAGEMENT_AREA_CONSTRUCTION,
              )}
            >
              공사 관리
            ...
            <Button
              ...
              onClick={() =>
                setManagementArea(MANAGEMENT_AREA_SAFETY)
              }
              sx={managementAreaButtonSx(
                MANAGEMENT_AREA_SAFETY,
              )}
