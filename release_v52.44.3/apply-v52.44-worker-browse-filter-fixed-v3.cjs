...
// 신규 근로자 등록에는 정상적으로
// '성명을 2자 이상 입력해주세요.' 검증이 남아있다.
// 따라서 파일 전체 문자열로 검사하지 않고,
// 구형 조회 RPC/조회 제한 로직이 제거되었는지만 검증한다.
if (
  nextText.includes(
