...
const targets = [
  {
    ...
    expected: ['2a232d9b036bfdb4cfa2674c284d67d9d6e2e9de62b3d84983d26f150ed137fb'],
    updated: '1e6ccee31f679386d0f759cac51fa38b89d7074eb64a0090adf2302a4b89b5cb',
  },
  {
    rel: 'src/utils/guideAnnotationEditor.js',
    expected: ['aa710112724f4fda37ebf274eac0b854efbce13cf4e18d6ae77ce9a1d6b465c9'],
    updated: '83ef2f0430e45dbf712ff637b8f3465b2677aecf430e5564651c3ccdf5573ffe',
  },
  {
    rel: 'src/utils/systemGuidePopup.js',
    expected: ['99d357fa63f60e261f31d994e10e3a999ce5aefd8b1d95424a311477e0834bfa'],
    updated: '7cdcf16ced6282ed419c5302f9b64a10bafbc941fb88ccb55bf40f4577e56be6',
  },
];
...
console.log('- .57에서 작아진 실제 가이드 표시 크기를 이전 기준으로 복원했습니다.');
console.log('- 표시 편집기는 실제 가이드 상세 이미지 크기를 기준으로 번호/설명박스 비율을 맞춥니다.');
